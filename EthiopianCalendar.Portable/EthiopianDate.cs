...
{
    public struct EthiopianDate : IComparable, IFormattable, IComparable<EthiopianDate>, IEquatable<EthiopianDate>
    {
       ...
       public string ToString(string format, IFormatProvider formatProvider)
        ...
        int IComparable.CompareTo(object obj)
        {
            ...
            {
                return _dateTime.CompareTo((DateTime) obj);
            }
            else
            {
                throw new NotSupportedException(obj.GetType().ToString() + " is Not Comparable to EthiopianDate");
            }
